...
CFLAGS=-mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -g -W -Wall -nostdlib -fomit-frame-pointer -fno-strict-aliasing -fdata-sections -I. -I../stm32f4 -I../libperiph -I../cm3 -I../libdsp -include stm32f4xx_conf.h -mfpu=fpv4-sp-d16 -DARM_MATH_CM4
